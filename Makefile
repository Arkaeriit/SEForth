...
# Files lists
C_SRC := dictionary.c forth_state.c C_func.c parser.c public_api.c sef_io.c block_c_func.c block_file.c block_c_func_weak.c
...
C_HEADER := sef_io.h SEForth.h C_func.h dictionary.h errors.h forth_state.h hash.h parser.h user_words.h sef_debug.h private_api.h block_c_func.h
TARGET := seforth
